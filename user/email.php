...
<section class="banner-area organic-breadcrumb">
  ...
  <div >
       <div class="container" style="width:80  %;">
             ...
             <div class="table-responsive"style="border-radius:35px ; box-shadow:8px 8px 8px grey ;">
                  <table class="table table-bordered" style="border:11px; background-color:#fff194; " >
                       <tr>
