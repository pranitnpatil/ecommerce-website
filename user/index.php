...
<body>
        <br />
        <div class="container" style="width:80  %;background-image:url('../images/main/banner.jpg')">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<form id="f1" method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
				    <div style="border:1px ; background-color:#f1f1f1; border-radius:5px; padding:16px; height:auto; margin-top:10px; " >
						
							<?php echo "<center><img  align=center src=../admin/".$row['thumb']." height=240 width=210  /></center>" ?><br />
							...
							<div class="product-details">
								...
								<input type="number"  name="quantity" class="form-control" min="1" max="10" value="1" size="7" />
